...
def generate_launch_description():
    urdf_file_path = 'src/description/vehicle_description_bigga_parent.urdf'
    ...
    default_model_path = os.path.join(pkg_share, 'src/description/vehicle_description_bigga_parent.urdf')
